      ...
      <div className="bg-white rounded-2xl shadow-xl p-10 max-w-md w-full text-center">
        ...
        {errorCode === 'PROFORMA_NOT_VALIDATED' && (
          <div className="flex flex-col sm:flex-row gap-2 justify-center mb-6">
            <Link to="/login" className="text-sm font-semibold text-blue-700 hover:underline">Se connecter</Link>
            <span className="hidden sm:inline text-gray-300">·</span>
            <Link to="/dashboard" className="text-sm font-semibold text-blue-700 hover:underline">Espace étudiant</Link>
          </div>
        )}
