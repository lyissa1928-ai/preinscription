...
const ACTIONS = ['', 'create', 'update', 'deactivate', 'delete_hard', 'batch_upsert', 'batch_delete']
const ENTITIES = ['', 'formation']
...
export default function AdminAuditLogs() {
  ...
  const [filters, setFilters] = useState({ q: '', action: '', entity: '' })
    ...
    <div className="max-w-7xl mx-auto px-4 py-6 space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-gray-500">Traçabilité des actions critiques (Lot 1/2)</p>
        </div>
      </div>
